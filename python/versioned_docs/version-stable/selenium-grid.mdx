...
Вам не нужно изменять ваш код, просто используйте ваш тестовый фреймворк или [browser_type.launch()](/api/class-browsertype.mdx#browser-type-launch) как обычно.
