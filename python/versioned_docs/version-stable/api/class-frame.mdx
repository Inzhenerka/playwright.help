...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено до v1.9</font><x-search>frame.add_script_tag</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено до v1.9</font><x-search>frame.add_style_tag</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено в: v1.13</font><x-search>frame.drag_and_drop</x-search>
...
- `no_wait_after` [bool] *(опционально)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="frame-drag-and-drop-option-no-wait-after"/><a href="#frame-drag-and-drop-option-no-wait-after" class="list-anchor">#</a>
  ...
  Эта опция не имеет эффекта.
- `source_position` [Dict] *(опционально)* <font size="2">Добавлено в: v1.14</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="frame-drag-and-drop-option-source-position"/><a href="#frame-drag-and-drop-option-source-position" class="list-anchor">#</a>
  - `x` [float]
...
- `target_position` [Dict] *(опционально)* <font size="2">Добавлено в: v1.14</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="frame-drag-and-drop-option-target-position"/><a href="#frame-drag-and-drop-option-target-position" class="list-anchor">#</a>
  - `x` [float]
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено до v1.9</font><x-search>frame.evaluate_handle</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено до v1.9</font><x-search>frame.frame_element</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено в: v1.17</font><x-search>frame.frame_locator</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено в: v1.27</font><x-search>frame.get_by_alt_text</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено в: v1.27</font><x-search>frame.get_by_label</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено в: v1.27</font><x-search>frame.get_by_placeholder</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено в: v1.27</font><x-search>frame.get_by_role</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено в: v1.27</font><x-search>frame.get_by_test_id</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено в: v1.27</font><x-search>frame.get_by_text</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено в: v1.27</font><x-search>frame.get_by_title</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено до v1.9</font><x-search>frame.is_enabled</x-search>
...
- `has_not` [Locator] *(опционально)* <font size="2">Добавлено в: v1.33</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="frame-locator-option-has-not"/><a href="#frame-locator-option-has-not" class="list-anchor">#</a>
  ...
  Обратите внимание, что внешние и внутренние локаторы должны принадлежать одному и тому же фрейму. Внутренний локатор не должен содержать [FrameLocator]s.
- `has_not_text` [str] | [Pattern] *(опционально)* <font size="2">Добавлено в: v1.33</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="frame-locator-option-has-not-text"/><a href="#frame-locator-option-has-not-text" class="list-anchor">#</a>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено до v1.9</font><x-search>frame.set_content</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено до v1.9</font><x-search>frame.wait_for_function</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено до v1.9</font><x-search>frame.wait_for_load_state</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено в: v1.11</font><x-search>frame.wait_for_url</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено до v1.9</font><x-search>frame.child_frames</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено до v1.9</font><x-search>frame.is_detached</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено до v1.9</font><x-search>frame.parent_frame</x-search>
...
- `no_wait_after` [bool] *(опционально)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="frame-check-option-no-wait-after"/><a href="#frame-check-option-no-wait-after" class="list-anchor">#</a>
  ...
  Этот параметр не имеет эффекта.
- `position` [Dict] *(опционально)* <font size="2">Добавлено в: v1.11</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="frame-check-option-position"/><a href="#frame-check-option-position" class="list-anchor">#</a>
  - `x` [float]
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено до v1.9</font><x-search>frame.dispatch_event</x-search>

:::warning[Не рекомендуется]

Используйте вариант на основе локаторов [locator.dispatch_event()](/api/class-locator.mdx#locator-dispatch-event) вместо этого. Подробнее о [локаторах](../locators.mdx).
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено в: v1.9</font><x-search>frame.eval_on_selector</x-search>

:::warning[Не рекомендуется]

Этот метод не ждёт, пока элемент пройдёт проверки пригодности к действию, и поэтому может приводить к нестабильным тестам. Вместо этого используйте [locator.evaluate()](/api/class-locator.mdx#locator-evaluate), другие вспомогательные методы [Locator] или web-first утверждения.
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено в: v1.9</font><x-search>frame.eval_on_selector_all</x-search>

:::warning[Не рекомендуется]

В большинстве случаев [locator.evaluate_all()](/api/class-locator.mdx#locator-evaluate-all), другие вспомогательные методы [Locator] и web-first утверждения справляются с задачей лучше.
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено до v1.9</font><x-search>frame.expect_navigation</x-search>

:::warning Deprecated

Этот метод по своей природе подвержен гонкам, пожалуйста, используйте [frame.wait_for_url()](/api/class-frame.mdx#frame-wait-for-url) вместо этого.
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено до v1.9</font><x-search>frame.get_attribute</x-search>
...
- `no_wait_after` [bool] *(опционально)* <font size="2">Добавлено в: v1.28</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="frame-hover-option-no-wait-after"/><a href="#frame-hover-option-no-wait-after" class="list-anchor">#</a>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено до v1.9</font><x-search>frame.inner_html</x-search>

:::warning[Не рекомендуется]

Используйте вариант на основе локаторов [locator.inner_html()](/api/class-locator.mdx#locator-inner-html) вместо этого. Подробнее о [локаторах](../locators.mdx).
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено до v1.9</font><x-search>frame.inner_text</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено в: v1.13</font><x-search>frame.input_value</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено до v1.9</font><x-search>frame.is_checked</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено до v1.9</font><x-search>frame.is_disabled</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено до v1.9</font><x-search>frame.is_editable</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено до v1.9</font><x-search>frame.is_hidden</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено до v1.9</font><x-search>frame.is_visible</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено в: v1.9</font><x-search>frame.query_selector</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено в: v1.9</font><x-search>frame.query_selector_all</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено до v1.9</font><x-search>frame.select_option</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено в: v1.15</font><x-search>frame.set_checked</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено до v1.9</font><x-search>frame.set_input_files</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено до v1.9</font><x-search>frame.text_content</x-search>
...
В большинстве случаев следует использовать [locator.fill()](/api/class-locator.mdx#locator-fill) вместо этого. Нажимать клавиши по одной нужно только при наличии специальной обработки клавиатуры на странице — в этом случае используйте [locator.press_sequentially()](/api/class-locator.mdx#locator-press-sequentially).
...
- `no_wait_after` [bool] *(опционально)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="frame-uncheck-option-no-wait-after"/><a href="#frame-uncheck-option-no-wait-after" class="list-anchor">#</a>
  ...
  Этот параметр не имеет эффекта.
- `position` [Dict] *(опционально)* <font size="2">Добавлено в: v1.11</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="frame-uncheck-option-position"/><a href="#frame-uncheck-option-position" class="list-anchor">#</a>
  - `x` [float]
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено до v1.9</font><x-search>frame.wait_for_selector</x-search>

:::warning[Не рекомендуется]

Вместо этого используйте web-assertions, которые проверяют видимость, или вариант на основе локатора — [locator.wait_for()](/api/class-locator.mdx#locator-wait-for). Подробнее о [локаторах](../locators.mdx).
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено до v1.9</font><x-search>frame.wait_for_timeout</x-search>

:::warning[Не рекомендуется]

Никогда не ждите тайм-аута в продакшене. Тесты, которые ждут по времени, по своей природе нестабильны. Используйте действия [Locator] и web-утверждения, которые ожидают автоматически.
