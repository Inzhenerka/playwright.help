...
- `has_not` [Locator] *(optional)* <font size="2">Добавлено в: v1.33</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="frame-locator-locator-option-has-not"/><a href="#frame-locator-locator-option-has-not" class="list-anchor">#</a>
  ...
  Обратите внимание, что внешние и внутренние локаторы должны принадлежать одному и тому же фрейму. Внутренний локатор не должен содержать [FrameLocator]s.
- `has_not_text` [str] | [Pattern] *(optional)* <font size="2">Добавлено в: v1.33</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="frame-locator-locator-option-has-not-text"/><a href="#frame-locator-locator-option-has-not-text" class="list-anchor">#</a>
