...
[API для скриншотов](./api/class-page#page-screenshot) принимает множество параметров для формата изображения, области обрезки, качества и т.д. Обязательно ознакомьтесь с ними.

## Скриншоты всей страницы {#full-page-screenshots}
...
## Захват в буфер {#capture-into-buffer}
...
## Скриншот элемента {#element-screenshot}
