...
Большие наборы тестов можно структурировать так, чтобы упростить написание и поддержку. Page Object Model — один из подходов к организации тестового набора.
