...
Playwright поддерживает пользовательские механизмы селекторов, регистрируемые с помощью [Selectors.RegisterAsync()](/api/class-selectors.mdx#selectors-register).
