...
- `options` `FrameDragAndDropOptions?` *(опционально)*
  ...
  - `Steps` [int]? *(optional)* <font size="2">Добавлено в: v1.57</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="frame-drag-and-drop-option-steps"/><a href="#frame-drag-and-drop-option-steps" class="list-anchor">#</a>
  ...
  - `Strict` [bool]? *(optional)* <font size="2">Добавлено в: v1.14</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="frame-drag-and-drop-option-strict"/><a href="#frame-drag-and-drop-option-strict" class="list-anchor">#</a>
