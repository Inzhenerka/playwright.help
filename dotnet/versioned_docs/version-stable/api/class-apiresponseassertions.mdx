...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено в: v1.18</font><x-search>apiResponseAssertions.ToBeOKAsync</x-search>
...
Делает проверку утверждения на противоположное условие. Например, этот код проверяет, что статус ответа не является успешным:
