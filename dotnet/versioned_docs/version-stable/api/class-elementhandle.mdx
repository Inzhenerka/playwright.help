...
- `options` `ElementHandleClickOptions?` *(опционально)*
  ...
  - `Steps` [int]? *(optional)* <font size="2">Добавлено в: v1.57</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="element-handle-click-option-steps"/><a href="#element-handle-click-option-steps" class="list-anchor">#</a>
...
- `options` `ElementHandleDblClickOptions?` *(опционально)*
  ...
  - `Position` Position? *(опционально)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="element-handle-dblclick-option-position"/><a href="#element-handle-dblclick-option-position" class="list-anchor">#</a>
    ...
    A point to use relative to the top-left corner of element padding box. If not specified, uses some visible point of the element.
  - `Steps` [int]? *(optional)* <font size="2">Добавлено в: v1.57</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="element-handle-dblclick-option-steps"/><a href="#element-handle-dblclick-option-steps" class="list-anchor">#</a>
