...
## Запуск тестов в параллельном режиме {#running-tests-in-parallel}
...
## Настройка параметров [BrowserContext] {#customizing-browsercontext-options}
...
## Настройка параметров запуска [Browser] {#customizing-browserlaunch-options}
...
## Использование подробных логов API {#using-verbose-api-logs}
...
## Использование файла .runsettings {#using-the-runsettings-file}
...
## Базовые классы для Playwright {#base-classes-for-playwright}
