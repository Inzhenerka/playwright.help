...
## Добавление примерных тестов {#add-example-tests}
...
## Запуск примерных тестов {#running-the-example-tests}
...
- [Запускайте один тест, несколько тестов, в режиме с интерфейсом](./running-tests.mdx)
- [Генерируйте тесты с помощью Codegen](./codegen-intro.mdx)
- [Просматривайте трассировку ваших тестов](./trace-viewer-intro.mdx)
- [Запускайте тесты в CI](./ci-intro.mdx)
- [Узнайте больше о базовых классах MSTest, NUnit, xUnit и xUnit v3](./test-runners.mdx)
