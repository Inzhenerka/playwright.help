...
[trace.playwright.dev](https://trace.playwright.dev) — это статически размещённый (statically hosted) вариант Trace Viewer. Вы можете загрузить trace-файл перетаскиванием (drag and drop) или через кнопку `Select file`.
...
### Просмотр удаленных трасс {#viewing-remote-traces}
...
## Возможности Trace Viewer {#trace-viewer-features}
