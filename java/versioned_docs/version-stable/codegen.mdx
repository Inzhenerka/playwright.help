...
###### 
![запись теста](https://github.com/microsoft/playwright/assets/13063165/ec9c4071-4af8-4ae7-8b36-aebcc29bdbbb)
...
###### 
![выбор локатора](https://github.com/microsoft/playwright/assets/13063165/733b48fd-5edf-4150-93f0-018adc52b6ff)
...
###### 
<img width="870" alt="Codegen генерирует код для тестов сайта playwright.dev с заданным размером области просмотра (Java)" src="https://user-images.githubusercontent.com/13063165/220402748-12a856c2-b3ff-4155-b82d-64dad9c46886.png" />
...
###### 
<img width="1300" alt="Codegen генерирует код для тестов сайта playwright.dev в эмуляции iPhone 13 (Java)" src="https://user-images.githubusercontent.com/13063165/220922591-241e6a59-a920-4cb1-97a2-d46c33ea17c5.png" />
...
###### 
<img width="1394" alt="Codegen генерирует код для тестов сайта playwright.dev в тёмном режиме (Java)" src="https://user-images.githubusercontent.com/13063165/220930514-3b105fab-c87e-4f58-affa-d11d570122a8.png" />
...
###### 
<img width="1394" alt="Codegen генерирует код для тестов Bing Maps: часовой пояс, геолокация — Рим (Италия), язык — итальянский (Java)" src="https://user-images.githubusercontent.com/13063165/220932268-9012163f-7673-4072-aa91-13b3c8f57799.png" />
...
###### 
<img width="1394" alt="страница GitHub до входа в систему (Java)" src="https://user-images.githubusercontent.com/13063165/220929236-08129e16-82a9-46a3-9f1c-3e59619c6289.png" />
...
###### 
<img width="1394" alt="GitHub после входа в систему: показано использование загрузки хранилища (Java)" src="https://user-images.githubusercontent.com/13063165/220928075-1e38347b-9d0d-4d9e-9a67-506c717893df.png" />

#### Используйте существующий `userDataDir` {#use-existing-userdatadir}

Запустите `codegen` с параметром `--user-data-dir`, чтобы задать фиксированный [каталог данных пользователя](https://playwright.dev/docs/api/class-browsertype#browser-type-launch-persistent-context-option-user-data-dir) для сессии браузера. Если вы создадите собственный каталог данных пользователя браузера, codegen будет использовать этот существующий профиль браузера и получит доступ к любому состоянию аутентификации, сохранённому в этом профиле.

:::warning

[Начиная с Chrome 136, к каталогу данных пользователя по умолчанию нельзя получить доступ с помощью средств автоматизации](https://developer.chrome.com/blog/remote-debugging-port), таких как Playwright. Для тестирования необходимо создать отдельный каталог данных пользователя.
:::
