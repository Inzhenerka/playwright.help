...
[Screenshots API](./api/class-page#page-screenshot) принимает множество параметров для формата изображения, области обрезки, качества и т.д. Обязательно ознакомьтесь с ними.
