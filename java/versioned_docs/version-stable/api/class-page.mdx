...
Use locator-based [Locator.hover()](/api/class-locator.mdx#locator-hover) instead. Подробнее о [locators](../locators.mdx).
...
Use locator-based [Locator.innerHTML()](/api/class-locator.mdx#locator-inner-html) instead. Подробнее о [locators](../locators.mdx).
...
Use locator-based [Locator.innerText()](/api/class-locator.mdx#locator-inner-text) instead. Подробнее о [locators](../locators.mdx).
...
Use locator-based [Locator.inputValue()](/api/class-locator.mdx#locator-input-value) instead. Подробнее о [locators](../locators.mdx).
...
Use locator-based [Locator.isChecked()](/api/class-locator.mdx#locator-is-checked) instead. Подробнее о [locators](../locators.mdx).
...
Use locator-based [Locator.isDisabled()](/api/class-locator.mdx#locator-is-disabled) instead. Подробнее о [locators](../locators.mdx).
...
Use locator-based [Locator.isHidden()](/api/class-locator.mdx#locator-is-hidden) instead. Подробнее о [locators](../locators.mdx).
...
Use locator-based [Locator.isVisible()](/api/class-locator.mdx#locator-is-visible) instead. Подробнее о [locators](../locators.mdx).
...
Use locator-based [Page.locator()](/api/class-page.mdx#page-locator) instead. Подробнее о [locators](../locators.mdx).
...
Use locator-based [Locator.selectOption()](/api/class-locator.mdx#locator-select-option) instead. Подробнее о [locators](../locators.mdx).
...
Use locator-based [Locator.setInputFiles()](/api/class-locator.mdx#locator-set-input-files) instead. Подробнее о [locators](../locators.mdx).
...
Use locator-based [Locator.tap()](/api/class-locator.mdx#locator-tap) instead. Подробнее о [locators](../locators.mdx).
...
Use locator-based [Locator.textContent()](/api/class-locator.mdx#locator-text-content) instead. Подробнее о [locators](../locators.mdx).
...
Use locator-based [Locator.uncheck()](/api/class-locator.mdx#locator-uncheck) instead. Подробнее о [locators](../locators.mdx).
