...
- `options` `ApiRequest.NewContextOptions` *(опционально)*
  ...
  - `setMaxRedirects` [int] *(опционально)* <font size="2">Добавлено в: v1.52</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="api-request-new-context-option-max-redirects"/><a href="#api-request-new-context-option-max-redirects" class="list-anchor">#</a>
