...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено в: v1.44</font><x-search>formData.append</x-search>
...
Разница между [FormData.set()](/api/class-formdata.mdx#form-data-set) и [FormData.append()](/api/class-formdata.mdx#form-data-append) заключается в том, что если указанный ключ уже существует, [FormData.set()](/api/class-formdata.mdx#form-data-set) перезапишет все существующие значения новым, тогда как [FormData.append()](/api/class-formdata.mdx#form-data-append) добавит новое значение в конец существующего набора значений.
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено в: v1.18</font><x-search>formData.create</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено в: v1.18</font><x-search>formData.set</x-search>
