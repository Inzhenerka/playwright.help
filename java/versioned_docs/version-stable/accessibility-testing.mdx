...
### Пример 1: Сканирование всей страницы {#example-1-scanning-an-entire-page}
...
### Пример 2: Настройка axe для сканирования конкретной части страницы {#example-2-configuring-axe-to-scan-a-specific-part-of-a-page}
...
### Пример 3: Сканирование на наличие нарушений WCAG {#example-3-scanning-for-wcag-violations}
...
Полный список тегов правил, которые поддерживает axe-core, можно найти в разделе [«Axe-core Tags» документации по axe API](https://www.deque.com/axe/core-documentation/api-documentation/#axecore-tags).
...
### Использование отпечатков нарушений для конкретных известных проблем {#using-violation-fingerprints-to-specific-known-issues}
