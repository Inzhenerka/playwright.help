...
Видео сохраняются при закрытии [контекста браузера](./browser-contexts.mdx) в конце теста. Если вы создаете контекст браузера вручную, убедитесь, что вы ожидаете [BrowserContext.close()](/api/class-browsercontext.mdx#browser-context-close).
