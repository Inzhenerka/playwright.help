...
| [assertThat(locator).isEditable()](/api/class-locatorassertions.mdx#locator-assertions-to-be-editable) | Элемент редактируемый |
...
| [assertThat(locator).isInViewport()](/api/class-locatorassertions.mdx#locator-assertions-to-be-in-viewport) | Элемент пересекает область просмотра |
...
| [assertThat(locator).hasAccessibleDescription()](/api/class-locatorassertions.mdx#locator-assertions-to-have-accessible-description) | Элемент имеет соответствующее [доступное описание](https://w3c.github.io/accname/#dfn-accessible-description) |
| [assertThat(locator).hasAccessibleName()](/api/class-locatorassertions.mdx#locator-assertions-to-have-accessible-name) | Элемент имеет соответствующее [доступное имя](https://w3c.github.io/accname/#dfn-accessible-name) |
| [assertThat(locator).hasAttribute()](/api/class-locatorassertions.mdx#locator-assertions-to-have-attribute) | Элемент имеет атрибут DOM |
| [assertThat(locator).hasClass()](/api/class-locatorassertions.mdx#locator-assertions-to-have-class) | Элемент имеет свойство класса |
...
| [assertThat(locator).hasRole()](/api/class-locatorassertions.mdx#locator-assertions-to-have-role) | Элемент имеет определенную [роль ARIA](https://www.w3.org/TR/wai-aria-1.2/#roles) |
| [assertThat(locator).hasText()](/api/class-locatorassertions.mdx#locator-assertions-to-have-text) | Элемент соответствует тексту |
| [assertThat(locator).hasValue()](/api/class-locatorassertions.mdx#locator-assertions-to-have-value) | Поле ввода имеет значение |
| [assertThat(locator).hasValues()](/api/class-locatorassertions.mdx#locator-assertions-to-have-values) | В списке выбраны опции |
