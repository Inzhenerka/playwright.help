...
## Ожидание события {#waiting-for-event}
...
Ожидание запроса с указанным URL с использованием [Page.waitForRequest()](/api/class-page.mdx#page-wait-for-request):
...
## Добавление/удаление слушателя событий {#addingremoving-event-listener}
...
## Добавление одноразовых слушателей {#adding-one-off-listeners}
