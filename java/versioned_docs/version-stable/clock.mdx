...
## Тестирование с предопределенным временем {#test-with-predefined-time}
...
## Последовательное время и таймеры {#consistent-time-and-timers}
...
## Тестирование мониторинга бездействия {#test-inactivity-monitoring}
...
## Ручное перемещение по времени, срабатывание всех таймеров последовательно {#tick-through-time-manually-firing-all-the-timers-consistently}
