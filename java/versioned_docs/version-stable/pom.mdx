...
Крупные наборы тестов можно структурировать так, чтобы упростить написание и поддержку. Одна из таких стратегий — использовать модель Page Object для организации тестового набора.
