...
### Запуск тестов в режиме UI {#run-tests-in-ui-mode}
...
### Запуск тестов в режиме с графическим интерфейсом {#run-tests-in-headed-mode}
...
### Запуск конкретных тестов {#run-specific-tests}
...
### Запуск последних неудачных тестов {#run-last-failed-tests}
...
### Запуск тестов в VS Code {#run-tests-in-vs-code}
...
### Отладка тестов в режиме UI {#debug-tests-in-ui-mode}
...
### Отладка тестов с помощью Playwright Inspector {#debug-tests-with-the-playwright-inspector}
