...
#### При push/pull_request (с шардингом) {#on-pushpull_request-sharded}
...
#### Загрузка папки playwright-report с Azure Pipelines {#uploading-playwright-report-folder-with-azure-pipelines}
...
#### Azure Pipelines (с шардингом) {#azure-pipelines-sharded}
...
#### Azure Pipelines (контейнеризированные) {#azure-pipelines-containerized}
...
#### Шардинг в CircleCI {#sharding-in-circleci}
