...
<font size="2" style={{position: "relative", top: "-20px"}}>Добавлено в: v1.55</font><x-search>testStepInfo.titlePath</x-search>

Полный путь заголовка, начинающийся с имени файла теста и включающий заголовки шагов. См. также [testInfo.titlePath](/api/class-testinfo.mdx#test-info-title-path).
