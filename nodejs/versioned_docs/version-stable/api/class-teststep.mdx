...
Представляет собой шаг в [TestRun].
...
Возвращает список заголовков шагов от корневого шага до этого шага.
...
Список файлов или буферов, прикрепленных в процессе выполнения шага через [testInfo.attach()](/api/class-testinfo.mdx#test-info-attach).
...
Необязательное местоположение в исходном коде, где определен шаг.
...
Время начала этого конкретного шага теста.
...
Список шагов внутри этого шага.
...
Удобочитаемое название шага теста.
