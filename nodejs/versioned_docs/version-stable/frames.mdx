...
[Page] может иметь один или несколько объектов [Frame], прикрепленных к нему. Каждая страница имеет основной фрейм, и взаимодействия на уровне страницы (такие как `click`) предполагается, что они выполняются в основном фрейме.
...
Можно получить доступ к объектам фреймов, используя API [page.frame()](/api/class-page.mdx#page-frame):
