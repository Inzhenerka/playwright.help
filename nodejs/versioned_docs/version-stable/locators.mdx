...
### Совпадение только видимых элементов {#matching-only-visible-elements}
...
#### Получение по n-му элементу {#get-by-nth-item}
...
#### Сделать что-то с каждым элементом в списке {#do-something-with-each-element-in-the-list}
