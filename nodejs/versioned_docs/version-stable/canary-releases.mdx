...
## Следующий dist-tag npm {#next-npm-dist-tag}
...
Вы можете увидеть текущие теги дистрибуции на [npm](https://www.npmjs.com/package/@playwright/test?activeTab=versions):
...
## Использование канарейкового релиза {#using-a-canary-release}
...
Стабильная и документация `next` публикуются на [playwright.dev](https://playwright.dev). Чтобы увидеть документацию `next`, нажмите <kbd>Shift</kbd> на клавиатуре `5` раз.
