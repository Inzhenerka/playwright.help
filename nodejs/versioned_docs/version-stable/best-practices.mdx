...
## Философия тестирования {#testing-philosophy}

### Тестируйте поведение, видимое пользователю {#test-user-visible-behavior}
...
### Делайте тесты максимально изолированными {#make-tests-as-isolated-as-possible}
...
### Избегайте тестирования сторонних зависимостей {#avoid-testing-third-party-dependencies}
...
### Тестирование с базой данных {#testing-with-a-database}
...
### Используйте локаторы {#use-locators}
...
#### Используйте цепочку и фильтрацию {#use-chaining-and-filtering}
...
#### Предпочитайте атрибуты, ориентированные на пользователя, XPath или CSS-селекторам {#prefer-user-facing-attributes-to-xpath-or-css-selectors}
...
### Генерация локаторов {#generate-locators}
...
#### Используйте `codegen` для генерации локаторов {#use-codegen-to-generate-locators}
...
#### Используйте расширение VS Code для генерации локаторов {#use-the-vs-code-extension-to-generate-locators}
...
### Используйте веб-утверждения {#use-web-first-assertions}
...
#### Не используйте ручные утверждения {#dont-use-manual-assertions}
...
#### Локальная отладка {#local-debugging}
...
### Используйте инструменты Playwright {#use-playwrights-tooling}
...
### Тестируйте во всех браузерах {#test-across-all-browsers}
...
### Держите вашу зависимость Playwright в актуальном состоянии {#keep-your-playwright-dependency-up-to-date}
...
### Запускайте тесты на CI {#run-tests-on-ci}
...
#### Оптимизация загрузки браузеров на CI {#optimize-browser-downloads-on-ci}
...
### Линтуйте ваши тесты {#lint-your-tests}
...
### Используйте параллелизм и шардирование {#use-parallelism-and-sharding}
...
### Используйте мягкие утверждения {#use-soft-assertions}
