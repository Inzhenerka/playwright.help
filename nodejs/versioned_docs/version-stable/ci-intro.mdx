...
## Настройка GitHub Actions {#setting-up-github-actions}
...
## Создание репозитория и пуш в GitHub {#create-a-repo-and-push-to-github}
...
## Открытие рабочих процессов {#opening-the-workflows}
...
## Просмотр логов тестов {#viewing-test-logs}
...
### Загрузка HTML-отчета {#downloading-the-html-report}
...
### Просмотр HTML-отчета {#viewing-the-html-report}
...
## Просмотр трассировки {#viewing-the-trace}
...
## Публикация отчета в интернете {#publishing-report-on-the-web}
...
## Правильная работа с секретами {#properly-handling-secrets}
