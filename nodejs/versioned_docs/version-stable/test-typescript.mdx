...
### Маппинг путей в tsconfig {#tsconfig-path-mapping}
...
### Разрешение tsconfig {#tsconfig-resolution}
...
## Ручная компиляция тестов с помощью TypeScript {#manually-compile-tests-with-typescript}
