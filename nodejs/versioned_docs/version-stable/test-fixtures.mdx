...
### Встроенные фикстуры {#built-in-fixtures}
...
## Создание фикстуры {#creating-a-fixture}
...
## Использование фикстуры {#using-a-fixture}
...
## Переопределение фикстур {#overriding-fixtures}
...
## Фикстуры с областью действия "worker" {#worker-scoped-fixtures}
...
## Автоматические фикстуры {#automatic-fixtures}
...
## Таймаут фикстуры {#fixture-timeout}
...
## Фикстуры-опции {#fixtures-options}
...
## Объединение пользовательских фикстур из нескольких модулей {#combine-custom-fixtures-from-multiple-modules}
...
## Пользовательский заголовок фикстуры {#custom-fixture-title}
...
## Добавление глобальных хуков beforeEach/afterEach {#adding-global-beforeeachaftereach-hooks}
...
## Добавление глобальных хуков beforeAll/afterAll {#adding-global-beforeallafterall-hooks}
