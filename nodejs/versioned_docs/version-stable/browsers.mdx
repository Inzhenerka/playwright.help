...
## Регулярное обновление Playwright {#update-playwright-regularly}
...
### Chromium: новый безголовый режим {#chromium-new-headless-mode}
...
### Герметичная установка {#hermetic-install}
