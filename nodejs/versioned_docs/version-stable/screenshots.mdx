...
[API скриншотов](./api/class-page#page-screenshot) принимает множество параметров для формата изображения, области обрезки, качества и т.д. Обязательно ознакомьтесь с ними.

## Скриншоты всей страницы

Скриншот всей страницы — это скриншот всей прокручиваемой страницы, как если бы у вас был очень высокий экран, и страница могла бы полностью в него поместиться.
