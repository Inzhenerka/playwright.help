...
## Использование контекста запросов {#using-request-context}
...
## Отправка API-запросов из UI-тестов {#sending-api-requests-from-ui-tests}
...
### Установление предусловий {#establishing-preconditions}
...
### Проверка постусловий {#validating-postconditions}
...
## Повторное использование состояния аутентификации {#reusing-authentication-state}
...
## Контекстный запрос vs глобальный запрос {#context-request-vs-global-request}
