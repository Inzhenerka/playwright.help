...
### Хуки до и после {#before-and-after-hooks}
...
## Параметризованные проекты {#parameterized-projects}
...
## Передача переменных окружения {#passing-environment-variables}
...
## Создание тестов через CSV файл {#create-tests-via-a-csv-file}
