...
### Установить тайм-аут теста в конфигурации {#set-test-timeout-in-the-config}
...
### Установить тайм-аут для одного теста {#set-timeout-for-a-single-test}
...
### Изменить тайм-аут из хука `beforeEach` {#change-timeout-from-a-beforeeach-hook}
...
### Изменить тайм-аут для хука `beforeAll`/`afterAll` {#change-timeout-for-beforeallafterall-hook}
...
## Тайм-аут ожидания {#expect-timeout}
...
### Установить тайм-аут ожидания в конфигурации {#set-expect-timeout-in-the-config}
...
### Указать тайм-аут ожидания для одного утверждения {#specify-expect-timeout-for-a-single-assertion}
...
## Глобальный тайм-аут {#global-timeout}
...
## Продвинутое: низкоуровневые тайм-ауты {#advanced-low-level-timeouts}
...
### Установить тайм-ауты действий и навигации в конфигурации {#set-action-and-navigation-timeouts-in-the-config}
...
### Установить тайм-аут для одного действия {#set-timeout-for-a-single-action}
...
## Тайм-аут фикстуры {#fixture-timeout}
