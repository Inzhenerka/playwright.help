...
## Открытие режима UI {#opening-ui-mode}
...
## Запуск ваших тестов {#running-your-tests}
...
## Фильтрация тестов {#filtering-tests}
...
## Просмотр временной шкалы {#timeline-view}
...
## Вынесение и исследование DOM {#pop-out-and-inspect-the-dom}
...
## Docker и GitHub Codespaces {#docker-github-codespaces}
