...
## Тестирование мониторинга неактивности {#test-inactivity-monitoring}
...
## Ручное перемещение по времени с последовательным срабатыванием всех таймеров {#tick-through-time-manually-firing-all-the-timers-consistently}
